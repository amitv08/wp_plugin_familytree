    ...
    <form id="edit-member-form" class="member-form">
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="first_name" name="first_name" value="<?php echo esc_attr($member->first_name); ?>" required>
                </div>
                <div class="form-group">
                    <label for="last_name">Last Name *</label>
                    <input type="text" id="last_name" name="last_name" value="<?php echo esc_attr($member->last_name); ?>" required>
                </div>
            </div>
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <input type="url" id="photo_url" name="photo_url" value="<?php echo esc_attr($member->photo_url); ?>" placeholder="https://example.com/photo.jpg">
            </div>
            <div class="form-group">
                <label for="biography">Biography</label>
                <textarea id="biography" name="biography" rows="4" placeholder="Tell us about this family member..."><?php echo esc_textarea($member->biography); ?></textarea>
            </div>
        </div>
        ...
        <div class="form-actions">
            ...
            <button type="button" class="btn btn-danger" onclick="deleteMember(<?php echo $member->id; ?>)">Delete Member</button>
        </div>
    </form>
